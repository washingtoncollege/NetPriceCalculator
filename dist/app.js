...
var EfcCalculator = function () {
    function EfcCalculator() {
        _classCallCheck(this, EfcCalculator);
    ...
    _createClass(EfcCalculator, [{
        key: 'calculateEfcDependent',
        value: function calculateEfcDependent(numberInCollege, numberInFamily, householdIncome) {
            var efc = 0;
            ...
            try {
                for (var _iterator = this._efcDependent[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var efcDependent = _step.value;
        ...
        key: 'calculateEfcIndWithoutChildren',
        value: function calculateEfcIndWithoutChildren(numberInCollege, numberInFamily, householdIncome) {
            ...
            try {
                for (var _iterator2 = this._efcIndWithoutChildren[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var efcIndWithoutChildren = _step2.value;
        ...
        key: 'calculateEfcIndWithChildren',
        value: function calculateEfcIndWithChildren(numberInCollege, numberInFamily, householdIncome) {
            var efc = 0;
            console.info('NIC:', numberInCollege, 'NIF:', numberInFamily, 'HI:', householdIncome);
            ...
            try {
                for (var _iterator3 = this._efcIndWithChildren[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var efcIndWithChildren = _step3.value;
        ...
        key: 'loadEfcDependent',
        value: function loadEfcDependent() {
            var efcDependent = [];
            efcDependent[0] = {};
        ...
        key: 'loadEfcIndWithoutChildren',
        value: function loadEfcIndWithoutChildren() {
        ...
        key: 'loadEfcIndWithChildren',
        value: function loadEfcIndWithChildren() {
            var efcIndWithDep = [];
            efcIndWithDep[0] = {};
    ...
    return EfcCalculator;
}();

exports.default = EfcCalculator;
...
var _EfcCalculator = __webpack_require__(1);

var _EfcCalculator2 = _interopRequireDefault(_EfcCalculator);

var _Calculator = __webpack_require__(14);

var _Calculator2 = _interopRequireDefault(_Calculator);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var efcCalculator = new _EfcCalculator2.default();
...
exports.default = {
    ...
    computed: {
        isDependent: function isDependent() {
            if (this.data.age < 24) {
                return this.data.married === 'No' && this.data.hasChildren === 'No';
            }
            return false;
        },
        householdIncome: function householdIncome() {
    ...
    methods: {
        ...
        step1Submit: function step1Submit() {
        ...
        step2Submit: function step2Submit() {
            this.goTo(3);
        },
        step3Submit: function step3Submit() {
        ...
        generateReport: function generateReport() {
            var efc = 0;
            if (this.isDependent) {
                efc = efcCalculator.calculateEfcDependent(this.data.numberInCollege, this.data.numberInFamily, this.data.householdIncome);
            } else {
                if (this.data.hasChildren === 'Yes') {
                    efc = efcCalculator.calculateEfcIndWithChildren(this.data.numberInCollege, this.data.numberInFamily, this.data.householdIncome);
                } else {
                    efc = efcCalculator.calculateEfcIndWithoutChildren(this.data.numberInCollege, this.data.numberInFamily, this.data.householdIncome);
                }
            }
...
module.exports = { render: function render() {
    ...
    return _c('div', {
      ...
      staticClass: "welcome"
    }, [_vm._m(0), _vm._v(" "), _c('p', [_vm._v("By clicking below, I acknowledge that the estimate provided using this calculator does not represent a final determination, or actual award, of financial assistance, or a final net price; it is an estimate based on cost of attendance and financial aid provided to students in a previous year. Cost of attendance and financial aid availability change year to year. The estimates shall not be binding on the Secretary of Education, the institution of higher education, or the State.")]), _vm._v(" "), _vm._m(1), _vm._v(" "), _vm._m(2)]) : _vm._e(), _vm._v(" "), _vm.currentStep === 1 ? _c('div', {
      staticClass: "step-1"
    }, [_c('h4', [_vm._v("Step 1:")]), _vm._v(" "), _c('p', [_vm._v("Please provide the requested information. Your responses will be used to calculate an estimated amount that students like you paid - after grant aid and scholarships but before student loans - to attend this institution in a given year.")]), _vm._v(" "), _c('div', {
      staticClass: "columns"
    }, [_c('div', {
      staticClass: "column col-8 centered"
    }, [_c('form', {
      ref: "step1",
    ...
    }, [_vm._v("Do you plan to apply for financial aid?")]), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.finAid,
        expression: "data.finAid"
      }],
      attrs: {
        "type": "radio",
        "name": "finAid",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.finAid, "Yes")
      },
      on: {
      ...
      domProps: {
        "checked": _vm._q(_vm.data.finAid, "No")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.finAid = "No";
    ...
    }, [_vm._v("How old are you?")]), _vm._v(" "), _c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.age,
      ...
      on: {
        "input": function input($event) {
          ...
          _vm.data.age = $event.target.value;
        },
      ...
      on: {
        "click": function click($event) {
          _vm.goTo(_vm.previousStep);
        }
      }
    }, [_vm._v("Go Back")]), _vm._v(" "), _c('button', {
      staticClass: "btn btn-primary",
      attrs: {
        "type": "submit"
      }
    }, [_vm._v("Continue")])])])])])]) : _vm._e(), _vm._v(" "), _vm.currentStep === 2 ? _c('div', {
      staticClass: "step-2"
    }, [_c('form', {
      ref: "step2",
      staticClass: "form-horizontal",
      ...
      on: {
        "submit": function submit($event) {
          $event.preventDefault();
          _vm.step2Submit($event);
        }
      }
    }, [_c('h4', [_vm._v("Step 2:")]), _vm._v(" "), _c('p', [_vm._v("Please provide the following information and then click Continue.")]), _vm._v(" "), _c('div', {
      staticClass: "form-group has-success"
    }, [_vm._m(5), _vm._v(" "), _c('div', {
      staticClass: "col-9"
    }, [_c('label', {
      staticClass: "form-label"
    }, [_vm._v("Are you (the student) married?")]), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.married,
        expression: "data.married"
      }],
      attrs: {
        "type": "radio",
        "name": "married",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.married, "Yes")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.married = "Yes";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
      ...
      domProps: {
        "checked": _vm._q(_vm.data.married, "No")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.married = "No";
      ...
      staticClass: "form-icon"
    }), _vm._v(" No")]), _vm._v(" "), _c('p', {
      staticClass: "form-input-hint"
    }, [_vm._v("(Answer \"yes\" if you are separated but not divorced.)")])])]), _vm._v(" "), _c('div', {
      staticClass: "form-group has-success"
    }, [_vm._m(6), _vm._v(" "), _c('div', {
      staticClass: "col-9"
    }, [_c('label', {
      staticClass: "form-label"
    }, [_vm._v("Are you (the student) the primary source of financial support for any children?")]), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.hasChildren,
        expression: "data.hasChildren"
      }],
      attrs: {
        "type": "radio",
        "name": "hasChildren",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.hasChildren, "Yes")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.hasChildren = "Yes";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
      ...
      domProps: {
        "checked": _vm._q(_vm.data.hasChildren, "No")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.hasChildren = "No";
        }
      }
    }), _c('i', {
      staticClass: "form-icon"
    ...
    }, [_vm._v("Continue")])])])]) : _vm._e(), _vm._v(" "), _vm.currentStep === 3 ? _c('div', {
      staticClass: "step-3"
    }, [_c('h4', [_vm._v("Step 3")]), _vm._v(" "), _c('p', [_vm._v("For the purposes of this calculator, an independent student is one who is at least 24 years old, married, and/or has legal dependents other than a spouse (e.g., children). A student who does not meet any of the above criteria is considered dependent.")]), _vm._v(" "), _c('p', [_vm._v("Based on the information you provided in previous steps, your dependency status is estimated to be "), _vm.isDependent ? _c('strong', [_vm._v("Dependent")]) : _c('strong', [_vm._v("Independent")]), _vm._v(". Please provide the following information and then click Continue\n\t\t")]), _vm._v(" "), _c('form', {
      staticClass: "form-horizontal",
      on: {
        "submit": function submit($event) {
          $event.preventDefault();
          _vm.step3Submit($event);
        }
      }
    }, [_c('div', [_c('div', {
      staticClass: "form-group"
    ...
    }, [_vm._v("How many people are in your family's household? "), _c('br'), _vm._v(" "), _vm.isDependent ? _c('small', [_vm._v("(Count yourself, your parent(s), and your parents' other dependent children.)")]) : _c('small', [_vm._v("Count yourself, your spouse (if applicable) "), _vm.data.hasChildren === 'Yes' ? _c('span', [_vm._v(", and any dependent children")]) : _vm._e(), _vm._v(".\n\n\n\n\n\n\n\t\t\t\t\t\t\t")])]), _vm._v(" "), _vm.isDependent ? _c('div', [_c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.numberInFamily,
        expression: "data.numberInFamily"
      }],
      attrs: {
        "type": "radio",
        "value": "2",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "2")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "2";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Two")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "3")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "3";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Three")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "4")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "4";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Four")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "5")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "5";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Five")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "6")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "6";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Six or more")])]) : _vm.data.hasChildren === 'No' ? _c('div', [_c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInFamily, "1")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInFamily = "1";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" One")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      staticClass: "form-icon"
    }), _vm._v(" Two")]), _c('br')]) : _c('div', [_c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      staticClass: "form-icon"
    }), _vm._v(" Six or more")])])])]), _vm._v(" "), _c('div', {
      staticClass: "form-group"
    ...
    }, [_vm._v("Of the number in your family above, how many will be in college next year?"), _c('br'), _vm._v(" "), _vm.isDependent ? _c('small', [_vm._v("(Count yourself and your siblings; do not count your parents.)")]) : _vm._e()]), _vm._v(" "), _vm.isDependent ? _c('div', [_c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.numberInCollege,
        expression: "data.numberInCollege"
      }],
      attrs: {
        "type": "radio",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInCollege, "1")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInCollege = "1";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" One child")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInCollege, "2")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInCollege = "2";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Two children")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.numberInCollege, "3")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.numberInCollege = "3";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Three or more children")])]) : _vm.data.hasChildren === 'No' ? _c('div', [_c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      staticClass: "form-icon"
    }), _vm._v(" Two or more")]), _c('br')])])]), _vm._v(" "), _c('div', {
      staticClass: "form-group"
    ...
    }, [_vm._v("What is your annual household income after taxes?\n\t\t\t\t\t\t"), _c('br'), _vm._v(" "), _vm.isDependent ? _c('small', [_vm._m(10)]) : _c('small', [_vm._v("(Include income from work, child support, and other sources; if you are married, include your spouse's income.)")])]), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: _vm.data.householdIncome,
        expression: "data.householdIncome"
      }],
      attrs: {
        "type": "radio",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "0")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "0";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Less than $30,000")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "1",
        "title": "Between $30,000 and $39,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "1")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "1";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $30,000 - $39,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "2",
        "title": "Between $40,000 and $49,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "2")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "2";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $40,000 - $49,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "3",
        "title": "Between $50,000 and $59,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "3")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "3";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $50,000 - $59,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "4",
        "title": "Between $60,000 and $69,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "4")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "4";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $60,000 - $69,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "5",
        "title": "Between $70,000 and $79,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "5")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "5";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $70,000 - $79,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "6",
        "title": "Between $80,000 and $89,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "6")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "6";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $80,000 - $89,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      attrs: {
        ...
        "name": "householdIncome",
        "value": "7",
        "title": "Between $90,000 and $99,999"
      },
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "7")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "7";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Between $90,000 - $99,999")]), _c('br'), _vm._v(" "), _c('label', {
      staticClass: "form-radio"
    }, [_c('input', {
      directives: [{
        name: "model",
      ...
      domProps: {
        "checked": _vm._q(_vm.data.householdIncome, "8")
      },
      on: {
        "__c": function __c($event) {
          _vm.data.householdIncome = "8";
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "form-icon"
    }), _vm._v(" Above $99,999")]), _c('br')])])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('div', {
      staticClass: "text-center"
    }, [_c('button', {
      staticClass: "btn btn-primary",
      attrs: {
    ...
    }, [_vm._v("Continue")])])])]) : _vm._e(), _vm._v(" "), _vm.currentStep === 'confirm' ? _c('div', {
      staticClass: "confirm"
    }, [_c('h4', [_vm._v("Confirm Estimate")]), _vm._v(" "), _c('p', [_vm._v("Review the information you have provided. You can click Modify to return to Step " + _vm._s(_vm.previousStep) + " and edit this information, or if you are happy with the current selections, click "), _c('strong', [_vm._v("Continue")]), _vm._v(" to receive your estimated net price.\n\t\t")]), _vm._v(" "), _c('table', {
      staticClass: "table table-hover"
    }, [_c('tbody', [_c('tr', [_vm._m(11), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.finAid))])]), _vm._v(" "), _c('tr', [_vm._m(12), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.age))])]), _vm._v(" "), _vm.data.married ? _c('tr', [_vm._m(13), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.married) + " "), _vm.data.married === 'Yes' ? _c('span', [_vm._v("(Married)")]) : _c('span', [_vm._v("(Not Married)")])])]) : _vm._e(), _vm._v(" "), _vm.data.hasChildren ? _c('tr', [_vm._m(14), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.hasChildren))])]) : _vm._e(), _vm._v(" "), _vm.data.numberInFamily ? _c('tr', [_vm._m(15), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.numberInFamily))])]) : _vm._e(), _vm._v(" "), _vm.data.numberInCollege ? _c('tr', [_vm._m(16), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.data.numberInCollege))])]) : _vm._e(), _vm._v(" "), _vm.householdIncome ? _c('tr', [_vm._m(17), _vm._v(" "), _c('td', [_vm._v(_vm._s(_vm.householdIncome))])]) : _vm._e()])]), _vm._v(" "), _c('br'), _vm._v(" "), _c('div', {
      staticClass: "text-center"
    }, [_c('button', {
      staticClass: "btn btn-primary",
      on: {
    ...
    }, [_vm._v("Modify")]), _vm._v(" "), _c('button', {
      staticClass: "btn btn-primary",
      on: {
        "click": _vm.generateReport
      }
    }, [_vm._v("Continue")])])]) : _vm._e(), _vm._v(" "), _vm.currentStep === 'result' ? _c('div', {
      staticClass: "result"
    }, [_c('h4', [_vm._v("Your estimates")]), _vm._v("\n\t\tEFC: " + _vm._s(_vm.estimates.efc) + "\n\t\t"), _c('div', {
      staticClass: "text-center"
    }, [_c('button', {
      staticClass: "btn btn-primary",
      on: {
      ...
      staticClass: "btn btn-primary"
    }, [_vm._v("Print")])])]) : _vm._e(), _vm._v(" "), _vm.currentStep === 0 ? _c('div', {
      staticClass: "text-center",
      slot: "panel-footer"
    }, [_c('button', {
      staticClass: "btn btn-primary",
    ...
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('p', [_c('strong', [_vm._v("Please read.")]), _vm._v(" This calculator is intended to provide estimated net price information (defined as estimated cost of attendance — including tuition and required fees, books and supplies, room and board (meals), and other related expenses — minus estimated grant and scholarship aid) to current and prospective students and their families based on what similar students paid in a previous year.\n\t\t")]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('p', [_vm._v("Students must complete the Free Application for Federal Student Aid (FAFSA) in order to be eligible for, and receive, an actual financial aid award that includes Federal grant, loan, or work-study assistance. For more information on applying for Federal student aid, go to "), _c('a', {
      attrs: {
        "href": "http://www.fafsa.ed.gov/"
      }
    }, [_vm._v("http://www.fafsa.ed.gov/")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('p', [_c('strong', [_vm._v("Note:")]), _vm._v(" Any information that you provide on this site is confidential. The Net Price Calculator does not store your responses or ask for personal identifying information of any kind.\n\t\t")]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "col-3"
    ...
    }, [_c('strong', [_vm._v("Financial Aid")])])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "col-3"
    ...
    return _c('div', {
      ...
      staticClass: "form-label"
    }, [_c('strong', [_vm._v("Marital Status")])])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "col-3"
    ...
    }, [_c('strong', [_vm._v("Number in Family")])])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "col-3"
    ...
    }, [_c('strong', [_vm._v("Number in College")])])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('div', {
      staticClass: "col-3"
    ...
    }, [_c('strong', [_vm._v("Household Income")])])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('ul', [_c('li', [_vm._v("Include income earned by yourself and your parent(s).")]), _vm._v(" "), _c('li', [_vm._v("Include income from work, child support, and other sources.")]), _vm._v(" "), _c('li', [_vm._v("If your parent is single, separated, or divorced, include the income for the parent with whom you live.")]), _vm._v(" "), _c('li', [_vm._v("If the parent with whom you live is remarried, include both your parent's income and his/her spouse's income.")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', {
      attrs: {
    ...
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Age")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Marital Status")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Children")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Number in Family")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Number in College")])]);
  }, function () {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;
    return _c('td', [_c('strong', [_vm._v("Household Income")])]);
  }] };
module.exports.render._withStripped = true;
if (false) {
  module.hot.accept();
  if (module.hot.data) {
    require("vue-hot-reload-api").rerender("data-v-401c9efa", module.exports);
  }
}
...
Component.options.__file = "/Users/jasontll/Code/NetPriceCalculator/resource/js/components/Calculator.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-401c9efa", Component.options)
  } else {
    hotAPI.reload("data-v-401c9efa", Component.options)
  }
})()}
...
var update = __webpack_require__(17)("3468682d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-401c9efa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Calculator.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-401c9efa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Calculator.vue");
